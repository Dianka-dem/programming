...
![alt text](</lab_9/kartinki/image.png>)

Вставили код функции любой сортировки

![alt text](</lab_9/kartinki/iimage.png>)

Вот так сейчас выглядит git status

![alt text](</lab_9/kartinki/image-1.png>)

Добавили файл в область add

![alt text](</lab_9/kartinki/image-2.png>)

Смотрим как сейчас выглядит git status

![alt text](</lab_9/kartinki/image-3.png>)

Закоммитим файл в репозиторий

![alt text](</lab_9/kartinki/image-4.png>)

Смотрим, как сейчас выглядит git status

![alt text](</lab_9/kartinki/image-7.png>)

Добавляем комментарий с любым текстом в этот файл

 ![alt text](</lab_9/kartinki/image-6.png>)

Смотрим, как выглядит git status

![alt text](</lab_9/kartinki/image-8.png>)

Добавляем add изменение файла

![alt text](</lab_9/kartinki/image-9.png>)

Смотрим, как выглядит git status 
![alt text](</lab_9/kartinki/image-10.png>)

Добавляем еще один комментарий

![alt text](</lab_9/kartinki/image-11.png>)

Делаем коммит

![alt text](</lab_9/kartinki/image-12.png>)

Смотрим, как выглядит git status

![alt text](</lab_9/kartinki/image-13.png>) 

Смотрим, как выглядит журнал log

![alt text](</lab_9/kartinki/image-14.png>)

Добавляем в add

![alt text](</lab_9/kartinki/image-15.png>)

Коммитим

![alt text](</lab_9/kartinki/image-16.png>)

Запушим на git push

![alt text](</lab_9/kartinki/image-17.png>)

Используем git branch mybranch, чтобы создать новую ветку с именем mybranch

![alt text](</lab_9/kartinki/image-18.png>).

Используем git branch, чтобы увидеть новую созданную ветку

![alt text](</lab_9/kartinki/image-19.png>)

Используем git switch mybranch, чтобы переключиться на новую ветку

![alt text](</lab_9/kartinki/image-20.png>)
...
![alt text](</lab_9/kartinki/image-21.png>)

Убеждаемся, что мы находимся на своей ветке

![alt text](</lab_9/kartinki/image-22.png>)

Создаем файл file1.txt и своим именем

![alt text](</lab_9/kartinki/image-23.png>)

Добавляем файл

![alt text](</lab_9/kartinki/image-24.png>)

Коммитем изменение

![alt text](</lab_9/kartinki/image-25.png>) 

Используйте git log --oneline --graph, чтобы увидеть, что ваша ветка указывает на новый коммит

![alt text](</lab_9/kartinki/image-26.png>)
Вернемся к ветке с именем master

![alt text](</lab_9/kartinki/image-27.png>)

Пропал коммит a54b0fa с file1.txt, так как он есть только в ветке mybranch

![alt text](</lab_9/kartinki/image-28.png>)

Создаем файл и коммитем его

![alt text](</lab_9/kartinki/image-29.png>)
...
![alt text](</lab_9/kartinki/image-30.png>)

Переключаемся на вашу ветку mybranch

![alt text](</lab_9/kartinki/image-31.png>)

Проверяем наличие file2.txt

![alt text](</lab_9/kartinki/image-32.png>)
...
![alt text](</lab_9/kartinki/image-33.png>)
...
![alt text](</lab_9/kartinki/image-43.png>)
...
![alt text](</lab_9/kartinki/image-45.png>)

Запускаю git restore –staged sort.c, чтобы отменить индексацию изменения

![alt text](</lab_9/kartinki/image-46.png>)

Мы перенесли обратно из stage в VSCode

![alt text](</lab_9/kartinki/image-47.png>)

Индексирую изменение (add) и делаю коммит

![alt text](</lab_9/kartinki/image-48.png>)

Вот так выглядит журнал

![alt text](</lab_9/kartinki/image-49.png>)

Добавляю в sort.c в main() printf(“hello git\n”);

![alt text](</lab_9/kartinki/image-50.png>)
...
![alt text](</lab_9/kartinki/image-51.png>)

Запустила git restore sort.c

![alt text](</lab_9/kartinki/image-52.png>)
...
![alt text](</lab_9/kartinki/image-71.png>)

git log --oneline --graph –all выводит, что находится HEAD на ветке mybranch

![alt text](</lab_9/kartinki/image-72.png>)

Запушисала изменения ветки master на удаленный репо

![alt text](</lab_9/kartinki/image-73.png>)


ОЦЕНКА 5
Создала ветку branch1

![alt text](</lab_9/kartinki/image-74.png>)

Переключилась на нее

![alt text](</lab_9/kartinki/image-75.png>)

Выполнила команду  echo "This is a relevant fact" > file.txt

![alt text](</lab_9/kartinki/image-76.png>)

Закоммитила  это изменение

![alt text](</lab_9/kartinki/image-77.png>)

Переключилась на главную ветку

![alt text](</lab_9/kartinki/image-87.png>)

Выполнила команду

![alt text](</lab_9/kartinki/image-88.png>)

Закоммитила именения в master

![alt text](</lab_9/kartinki/image-89.png>
)
Вот что вывел git log --oneline --graph –all

![alt text](</lab_9/kartinki/image-90.png>)

Использовала команду git merge чтобы смержить ветку branch1 в master (получла конфликт это норм)

![alt text](</lab_9/kartinki/image-91.png>)
...
![alt text](</lab_9/kartinki/image-92.png>)

Показывает истории коммитов

![alt text](</lab_9/kartinki/image-93.png>)

Запушила изменения

![alt text](</lab_9/kartinki/image-94.png>)

Проиндексировала файл и закоммитила

![alt text](</lab_9/kartinki/image-95.png>)

Создаю новую ветку Mergesort-Impl и переключаюсь на нее

![alt text](</lab_9/kartinki/image-96.png>)

Содержимое файла mergesort.py заменила на код из righty.py и закоммитила

![alt text](</lab_9/kartinki/image-97.png>)

Перешла на ветку master

![alt text](</lab_9/kartinki/image-98.png>)

Поменяла все содержимое mergesort.py на lefty.py и закоммитила

![alt text](</lab_9/kartinki/image-99.png>)

Показывает историю коммитов

![alt text](</lab_9/kartinki/image-100.png>)

git branch показывает, что я нахожусь на ветке master

![alt text](</lab_9/kartinki/image-101.png>)

Смержила  Mergesort-Impl в master

![alt text](</lab_9/kartinki/image-102.png>)

После исправления всех merge конфликтов запушила в master изменения

![alt text](</lab_9/kartinki/image-103.png>)


![alt text](image.png>) ![alt text](image-1.png>) ![alt text](image-2.png>) ![alt text](image-3.png>) ![alt text](image-4.png>) ![alt text](image-5.png>) ![alt text](image-6.png>) ![alt text](image-7.png>) ![alt text](image-8.png>) ![alt text](image-9.png>) ![alt text](image-10.png>) ![alt text](image-11.png>) ![alt text](image-12.png>) ![alt text](image-13.png>) ![alt text](image-14.png>) ![alt text](image-15.png>) ![alt text](image-16.png>) ![alt text](image-17.png>) ![alt text](image-18.png>) ![alt text](image-19.png>) ![alt text](image-20.png>) ![alt text](image-21.png>) ![alt text](image-22.png>) ![alt text](image-23.png>) ![alt text](image-24.png>) ![alt text](image-25.png>) ![alt text](image-26.png>) ![alt text](image-27.png>) ![alt text](image-28.png>) ![alt text](image-29.png>) ![alt text](image-30.png>) ![alt text](image-31.png>) ![alt text](image-32.png>) ![alt text](image-33.png>) ![alt text](image-34.png>) ![alt text](image-35.png>) ![alt text](image-36.png>) ![alt text](image-37.png>) ![alt text](image-38.png>) ![alt text](image-39.png>) ![alt text](image-40.png>) ![alt text](image-41.png>) ![alt text](image-42.png>) ![alt text](image-43.png>) ![alt text](image-44.png>) ![alt text](image-45.png>) ![alt text](image-46.png>) ![alt text](image-47.png>) ![alt text](image-48.png>) ![alt text](image-49.png>) ![alt text](image-50.png>) ![alt text](image-51.png>) ![alt text](image-52.png>) ![alt text](image-53.png>) ![alt text](image-54.png>) ![alt text](image-55.png>) ![alt text](image-56.png>) ![alt text](image-57.png>) ![alt text](image-58.png>) ![alt text](image-59.png>) ![alt text](image-60.png>) ![alt text](image-61.png>) ![alt text](image-62.png>) ![alt text](image-63.png>) ![alt text](image-64.png>) ![alt text](image-65.png>) ![alt text](image-66.png>) ![alt text](image-67.png>) ![alt text](image-68.png>) ![alt text](image-69.png>) ![alt text](image-70.png>) ![alt text](image-71.png>) ![alt text](image-72.png>) ![alt text](image-73.png>) ![alt text](image-74.png>) ![alt text](image-75.png>) ![alt text](image-76.png>) ![alt text](image-77.png>) ![alt text](image-78.png>) ![alt text](image-79.png>) ![alt text](image-80.png>) ![alt text](image-81.png>) ![alt text](image-82.png>) ![alt text](image-83.png>) ![alt text](image-84.png>) ![alt text](image-85.png>) ![alt text](image-86.png>) ![alt text](image-87.png>) ![alt text](image-88.png>) ![alt text](image-89.png>) ![alt text](image-90.png>) ![alt text](image-91.png>) ![alt text](image-92.png>) ![alt text](image-93.png>) ![alt text](image-94.png>) ![alt text](image-95.png>) ![alt text](image-96.png>) ![alt text](image-97.png>) ![alt text](image-98.png>) ![alt text](image-99.png>) ![alt text](image-100.png>) ![alt text](image-101.png>) ![alt text](image-102.png>) ![alt text](image-103.png>) ![alt text](iimage-1.png>)