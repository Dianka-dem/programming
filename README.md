...
![alt text](kartinki/iimage.png)

Вот так сейчас выглядит git status

![alt text](kartinki/image-1.png)

Добавили файл в область add

![alt text](kartinki/image-2.png)

Смотрим как сейчас выглядит git status

![alt text](kartinki/image-3.png)

Закоммитим файл в репозиторий

![alt text](kartinki/image-4.png)

Смотрим, как сейчас выглядит git status

![alt text](kartinki/image-7.png)

Добавляем комментарий с любым текстом в этот файл

 ![alt text](kartinki/image-6.png)

Смотрим, как выглядит git status

![alt text](kartinki/image-8.png)

Добавляем add изменение файла

![alt text](kartinki/image-9.png)

Смотрим, как выглядит git status 
![alt text](kartinki/image-10.png)

Добавляем еще один комментарий

![alt text](kartinki/image-11.png)

Делаем коммит

![alt text](kartinki/image-12.png)

Смотрим, как выглядит git status

![alt text](kartinki/image-13.png) 

Смотрим, как выглядит журнал log

![alt text](kartinki/image-14.png)

Добавляем в add

![alt text](kartinki/image-15.png)

Коммитим

![alt text](kartinki/image-16.png)

Запушим на git push

![alt text](kartinki/image-17.png)

Используем git branch mybranch, чтобы создать новую ветку с именем mybranch

![alt text](kartinki/image-18.png).

Используем git branch, чтобы увидеть новую созданную ветку

![alt text](kartinki/image-19.png)

Используем git switch mybranch, чтобы переключиться на новую ветку

![alt text](kartinki/image-20.png)
...
![alt text](kartinki/image-30.png)

Переключаемся на вашу ветку mybranch

![alt text](kartinki/image-31.png)

Проверяем наличие file2.txt

![alt text](kartinki/image-32.png)
...
![alt text](kartinki/image-33.png)
...
![alt text](kartinki/image-43.png)
...
![alt text](kartinki/image-51.png)

Запустила git restore sort.c

![alt text](kartinki/image-52.png)
